...
const ResearchPublications = () => {
  ...
  const publications = [
    ...
    const interests = [
        { id: 'astronomy', image: '/astronomy.webp', description: 'Exploring the cosmos' },
        { id: 'photography', image: '/photography.avif', description: 'Capturing nature\'s beauty' },
        { id: 'music', image: '/music.jpg', description: 'Enjoying classical compositions' },
      ];
  ...
  return (
          <div className={styles.researchContainer}>
                ...
                <div className={styles.bannerImageContainer}>
                  <img src="/research_banner.jpg" alt="Computational Particle Physics Research" className={styles.bannerImage} />
                </div>
